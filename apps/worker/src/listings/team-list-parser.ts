...
- A TEAM WITH A NAME BUT NO NUMBER. Sometimes the list clearly names a team (a pre-rookie, a late entry) but shows no number beside it. Still include it: give it a placeholder number from the 9970-9999 range, choosing the lowest value in that range not already used by another entry in the array you return. Only do this for something that is unmistakably a REGISTERED team in the list, never for stray text.
- AN INVITATION IS NOT A TEAM. A placeholder row that invites the reader to sign up, such as "Team ????", "Team ??? An Awesome Team (You)", "Your Team Here", "Register your team here", "Sample Team", or "Your team could be here", is a call to action, not a registrant. Skip it entirely: do NOT read a number from it and do NOT give it a 9970-9999 placeholder.
