...
const GRANT_CHANGE_TARGETS: Record<string, ChangeTarget> = {
  ...
  applyMethod: { table: 'grant', column: 'applyMethod', type: 'text', label: 'How to apply', priority: 1 },
  contactEmail: { table: 'grant', column: 'contactEmail', type: 'text', label: 'Contact email', priority: 1 },
  mailingAddress: { table: 'grant', column: 'mailingAddress', type: 'text', label: 'Mailing address', priority: 2 },
