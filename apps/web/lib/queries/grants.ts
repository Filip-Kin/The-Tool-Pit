...
const publicGrantColumns = {
  ...
  applyRouteStatus: grants.applyRouteStatus,
  applyRouteEvidence: grants.applyRouteEvidence,
  deadlineProof: grants.deadlineProof,
  deadlineProofUrl: grants.deadlineProofUrl,
  deadlineProofCheckedAt: grants.deadlineProofCheckedAt,
...
function toPublicGrant(
  ...
  return {
    ...
    applyRouteStatus: (row.applyRouteStatus as string | null) ?? null,
    applyRouteEvidence: (row.applyRouteEvidence as string | null) ?? null,
    deadlineProof: (row.deadlineProof as string | null) ?? null,
    deadlineProofUrl: (row.deadlineProofUrl as string | null) ?? null,
    deadlineProofCheckedAt: (row.deadlineProofCheckedAt as Date | null) ?? null,
